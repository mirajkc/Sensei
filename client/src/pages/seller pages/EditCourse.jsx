...
const EditCourse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(`/api/course/updatecourse/${courseId}`, formData, {
        headers: {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1">
        <main className={`flex-1 p-6 overflow-auto ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-50 text-black'}`}>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`${inputClass} ${theme === 'dark' ? 'bg-gray-600' : 'bg-gray-100'} cursor-not-allowed`}
                        disabled
                        readOnly
                      />
                    </div>
